...
while ((chips > 0) and (player_input == "yes")):
	...
	if (((player.value>dealer.value) and (player.value<22)) or (dealer.value > 21)): #Player wins
		print("\nYou win!\n")
		chips = chips + bet
		print("You now have ",chips," chips in your stack!")
	
	elif((player.value<dealer.value) or (player.value > 21)): #Dealer wins
		print("\nYou lose!\n")
		chips=chips-bet
		print(f"You now have {chips} chips in your stack.")
